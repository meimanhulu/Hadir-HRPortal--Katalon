...
WebUI.verifyElementText(findTestObject('ManagemenHalaman/p_Test Cuti'), 'Test Cuti')

WebUI.click(findTestObject('Object Repository/ManagemenHalaman/p_Test Cuti'))
