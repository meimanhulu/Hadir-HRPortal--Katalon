...
public class HardTokenRegistrationPages{
	...
	private TestObject btnStatus2
	private TestObject btnStatus3
	...
	def HardTokenRegistrationPages(String startDate, String endDate, String status, String status2, String status3) {
		...
		btnStatus2 = ObjectGlobal.getTestObject("//button[span[text()='${status2}']]")
		btnStatus3 = ObjectGlobal.getTestObject("//button[span[text()='${status3}']]")
	...
	def Status2() {
		WebUI.verifyElementPresent(btnStatus2, 5)
		WebUI.waitForElementClickable(btnStatus2, 5)
		WebUI.click(btnStatus2)
		WebUI.takeScreenshot()
	}

	def Status3() {
		WebUI.verifyElementPresent(btnStatus3, 5)
		WebUI.waitForElementClickable(btnStatus3, 5)
		WebUI.click(btnStatus3)
		WebUI.takeScreenshot()
	}
